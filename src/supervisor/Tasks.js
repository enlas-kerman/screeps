...
const FillEnergyTask = require('task_FillEnergyTask');
...
taskFws[FillEnergyTask.TYPE] = new FillEnergyTask();
...
const Tasks = class {
    ...
    constructor(room, memory) {
        ...
        memory.types[FillEnergyTask.TYPE] = memory.types[FillEnergyTask.TYPE] || {};
